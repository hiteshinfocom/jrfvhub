...
applyFilters();
      ...
      Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            hintText: "Search PO No, Item Name",
                                  ...
                                  Table(
                                    ...
                                    children: [
                                      ...
                                      TableRow(
                                        children: [
                                          tableValue(
                                            "${item["DrawingNo"]?.toString().isEmpty ?? true ? "-" : item["DrawingNo"]}\nRev: ${item["revision"] ?? "-"}",
                                          ),

                                          tableValue(
                                            item["issueqty"]?.toString() ?? "0",
                                          ),

                                          tableValue(
                                            item["FinishQty"]?.toString() ?? "0",
                                          ),

                                          tableValue(
                                            item["BalacnceQty"]?.toString() ?? "0",
                                          ),
                                        ],
                                      ),
  ...
  List<dynamic> data = List.from(poList);
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  // await PurchaseOrderService.dispatchMaterial(data);

                  final result =
                      await PurchaseOrderService.dispatchMaterial(
                    data,
                  );
      ...
      actions: [
        ...
        ElevatedButton(
          onPressed: () async {
            ...
            final result =
                await PurchaseOrderService.completePO(
              issueId:
                  item["issueid"].toString(),
              finishQty:
                  qtyController.text,
