...
import '../../screens/chat/full_image_screen.dart';
...
class AdminChatScreen extends StatefulWidget {
  ...
  @override
  State<AdminChatScreen> createState() =>
      _AdminChatScreenState();
}

class _AdminChatScreenState
    extends State<AdminChatScreen> {
  ...
  void initState() {
    ...
    SocketService.instance.registerUser(widget.adminId);
